...
const Contact = () => {
  ...
  return (
   <>
    ...
    <div className='md:px-56 px-3 flex flex-col md:flex-row md:gap-20 gap-10'>
        
        <div className='md:w-1/2 border-1 border-gray-300 ' data-aos="zoom-in" >
        <p className='font-serif text-lg md:text-3xl text-center font-bold pt-5'>Getting in touch</p>
           <div className='flex px-3 items-center mt-5 justify-center gap-8'>
                ...
                <div className='font-serif flex flex-col gap-8'>
                    <p className=' md:text-2xl '>Nayabasti, Gokarneshwor-5</p>
                    <p className='md:text-2xl '>Kathmandu, Nepal</p>
                    <p className=' md:text-2xl '>magarbibek71@gmail.com</p>
                </div>
           </div>
        </div>
        <div className='md:w-1/2 px-5 border-1 border-gray-300 rounded-2xl' data-aos="zoom-in"> 
            ...
            <form action="" className='flex flex-col justify-center font-serif' onSubmit={handleSubmit}>
                ...
                <input type="text" name="username" id="name" placeholder='eg:Bibek ' className='border-2 border-black w-full px-2 rounded-md '/>
                <label htmlFor="email" className='py-2'>Enter your email</label>
                <input type="email" name="useremail" id="email"  placeholder='eg:kendrix@gmail.com' className='border-2 border-black w-full px-2 rounded-md ' />
                <label htmlFor="message" className='py-2'>Message</label>
                <textarea type="text" name="description" id="message" placeholder='Leave your message' className='border-2 border-black w-full px-2 rounded-md ' />
