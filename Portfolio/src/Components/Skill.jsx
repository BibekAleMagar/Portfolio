...
useEffect(() => {
  ...
  return (
    <>
        ...
        <div className='flex md:flex-row flex-col gap-5 justify-center px-3 md:px-56 mb-5' > 
            <div className='border-2 border-gray-300 p-4 md:w-1/2 w-full rounded-2xl' data-aos="zoom-in">
              <p className='font-serif text-center text-xl md:text-2xl md:mb-5 mb-2'>Techincal Skills</p>
                <div className='grid grid-cols-2 md:px-20 md:gap-x-12 gap-5'>
                  <div>
            ...
            <div className='border-2 border-gray-300 p-4 md:w-1/2 w-full rounded-2xl' data-aos="zoom-in" >
              <p className='font-serif text-center text-xl md:text-2xl md:mb-5 mb-2'>Non-Techincal Skills</p>
                <div className='grid grid-cols-2 md:px-12 md:gap-x- gap-y-5'>
                  <div>
